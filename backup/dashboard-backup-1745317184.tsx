...
const CompleteDashboard: React.FC<CompleteDashboardProps> = ({ className }) => {
  ...
  return (
    <div className={cn("container-apple section-apple bg-[#F9F9F9] px-0 mx-0 sm:px-4 pb-36 mb-12 -mt-6", className)}>
      ...
      <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6 mt-2 md:mt-4 transition-all duration-300 ease-in-out ${isFetching ? 'opacity-80 scale-[0.99] blur-[0.3px]' : 'opacity-100 scale-100 blur-0'}`}>
