...
export default function SimpleLibroRegistros({ params: propsParams, forceOwnUser = false }: LibroRegistrosSimpleProps) {
  ...
  // Obtener los datos filtrados - usamos una función que genera los datos cuando se necesite
  // pero NO creamos una variable constante para evitar problemas de recursión
  
  // Función para descargar como PDF
  const handleDownloadPDF = () => {
    // Generamos los datos filtrados al momento de usarlos
      ...
      <div className="bg-white rounded-lg shadow mb-6 p-4 border border-gray-100">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          <div className="flex items-end space-x-2 justify-end">
            ...
            <Button 
              variant="outline" 
              className="flex items-center bg-green-50 border-green-200 hover:bg-green-100 text-green-700 px-6 min-w-[150px]"
