...
// Layout por defecto totalmente vacío
...
const EmptyDashboard = ({ userId }: EmptyDashboardProps) => {
  ...
  // Estado local para los bloques en el dashboard, siempre vacío inicialmente
  const [activeBlocks, setActiveBlocks] = useState<string[]>(EMPTY_LAYOUT);
