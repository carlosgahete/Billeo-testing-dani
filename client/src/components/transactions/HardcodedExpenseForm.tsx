...
interface HardcodedExpenseFormProps {
  onSuccess?: () => void;
}

const HardcodedExpenseForm: React.FC<HardcodedExpenseFormProps> = ({ onSuccess }) => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Crear una transacción directamente en la API estándar
...
export default HardcodedExpenseForm;