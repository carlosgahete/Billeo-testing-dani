      ...
      try {
        ...
        if (lines.length > 0) {
          ...
          if (firstLineParts.length >= 2) {
            ...
            console.log("Datos de cliente extraídos de las notas para presupuesto:", {
              name: clientName,
              taxId: clientTaxId,
              email: clientEmail,
              address: clientAddress
        ...
        console.error("Error al extraer datos del cliente de las notas para presupuesto:", error);
      }
    }
