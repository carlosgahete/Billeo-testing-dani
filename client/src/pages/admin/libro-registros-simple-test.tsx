...
// Componente de prueba exclusivamente para depuración - No requiere autenticación
export default function LibroRegistrosSimpleTest() {
  ...
  const fetchLibroData = async () => {
    try {
      setLoading(true);
      const response = await fetch(`/api/libro-registros/${userId}?year=${selectedYear}&quarter=${selectedQuarter}&month=${selectedMonth}&card=${selectedCard}`);
    ...
    <div className="container mx-auto p-4 sm:p-6">
      <div className="flex flex-col space-y-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4">
          <h1 className="text-2xl font-bold">Libro de Registros (TEST)</h1>
