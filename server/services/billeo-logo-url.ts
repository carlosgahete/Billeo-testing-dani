...
// URL para el logo de Billeo
// En un entorno de producción, usa una URL absoluta del dominio real
// En desarrollo, usamos una combinación de opciones para máxima compatibilidad
