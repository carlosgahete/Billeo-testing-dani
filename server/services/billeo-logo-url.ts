...
// En lugar de usar una URL para el logo de Billeo, utilizaremos un enfoque de solo texto
// para máxima compatibilidad con clientes de correo electrónico
export const BILLEO_LOGO_URL = '';
